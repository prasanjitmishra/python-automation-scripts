...
import MySQLdb
import datetime
csvfile = '/home/user/Desktop/brandranking/averageData.csv'
...
for row in reader:
	try:
		...
		# cursor.execute("INSERT INTO Brandranking VALUES ('2016-10-01',"+row[1]+","+row[2]+","+row[3]+")");
		cursor.execute("INSERT INTO Brandranking_Industry_Average VALUES ("+row[0]+","+row[1]+","+row[2]+","+row[3]+")");
		mydb.commit()
